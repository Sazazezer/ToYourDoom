...
//draw full hearts
    repeat(floor(hp / parts)){
        draw_sprite(heart,0,bar_x+width*xoffset*index,bar_y+height*yoffset*bar/*+20*/)
        index += 1
        if index = bar_length{
            bar +=1
            index = 0
...
//draw partial heart
    if hp mod parts >0{
        draw_sprite(heart,parts - hp mod parts,bar_x+width*xoffset*index,bar_y+height*yoffset*bar/*+20*/)
        index += 1
        if index = bar_length{
            bar +=1
            index = 0
...
//draw empty hearts
    repeat(floor(max_hp/parts - hp/parts)){
        draw_sprite(heart,parts,bar_x+width*xoffset*index,bar_y+height*yoffset*bar/*+20*/)
        index += 1
        if index = bar_length{
            bar +=1
            index = 0
